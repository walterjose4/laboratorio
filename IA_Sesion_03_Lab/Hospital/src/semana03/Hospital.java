...
public class Hospital extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnProcesar(ActionEvent arg0) {
		...
		double donacion,medGeneral,pedia,trauma,neumo,gineco;
		//entrada de datos
		donacion=Double.parseDouble(txtDonacionSoles.getText());
		//proceso de calculo
		medGeneral=0.17*donacion;
		pedia=0.35*donacion;
		trauma=0.23*donacion;
		neumo=0.15*donacion;
		gineco=donacion-medGeneral-pedia-trauma-neumo;
		//salida de resultados
		txtS.setText("REPARTO DE LA DONACIÓN\n");
		txtS.append("Medicina General : S/. "+medGeneral);
		txt
	}
}